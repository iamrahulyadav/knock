...
import com.proclivis.smartknock.Adapter.OfflineVisitorVerifyAdapter;
import com.proclivis.smartknock.Adapter.VisitorVerifyAdapter;
...
public class VisitorVerifyActivity extends AppCompatActivity {

    @SuppressLint("StaticFieldLeak")
    public static RelativeLayout progress, llMain;
    @SuppressLint("StaticFieldLeak")
    public static Activity activity;
    LinearLayout toolbar, llBack, llHome, llSearch;
    Context context;
    LinearLayout llLeft;
    ViewPager viewPager;
    ArrayList<GetVisitorVo> getVisitorVos = new ArrayList<>();
    String mode;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.visitor_veryfy_activity);
        ...
        if (extras == null) {
            ...
            if (mode.equals("online")) {
                ...
                viewPager.setAdapter(new VisitorVerifyAdapter(context, getVisitorVos));
            } else {
                viewPager.setAdapter(new OfflineVisitorVerifyAdapter(context, Constant.getVisitorVo));
            }
        }
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityStatus.isConnected()) {
                Util.uploadInVisitor(VisitorVerifyActivity.this, llMain);
            }
        }
    };
}